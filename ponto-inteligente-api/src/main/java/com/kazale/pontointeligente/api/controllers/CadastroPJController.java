...
@CrossOrigin(origins = "*")//aceita conexão de qualquer origem
public class CadastroPJController {
	 ...
	 */
	@PostMapping //verbo http que está sendo utilizado
	//@valid invoca a validação do dto
	//@request body habilita o parâmetro do método
